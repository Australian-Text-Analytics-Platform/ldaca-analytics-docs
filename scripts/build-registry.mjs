...
//
// `registry.json` and the markdown are generated by the main app's
// `docs:sync-publish` command. This mirror-side gate checks that every entry
// refers to an existing file with a present `<a id="anchor">` (or a heading
// with the same slug).
//
